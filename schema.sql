...
INSERT INTO rooms (name_hu, name_ua, description_hu, description_ua, photo_ref, sort_order) VALUES
  ...
  ('Hangulatos hálószoba', 'Затишна спальня',          ' (Franciaágy és pótágy, saját fürdőszoba, TV és kis hűtő a szobában.)', ' (Двоспальне ліжко, очеретяна стеля та ткані настінні прикраси, ламінована підлога.)', 'cap2', 5),
